...
- [External Code Graph Providers](concepts/code-graph-providers.md) — `crates/code-graph-provider/src/lib.rs`, `crates/code-graph-provider/Cargo.toml`, `src/main.rs`, `fixtures/code-graph-provider/basic/manifest.json`, `fixtures/code-graph-provider/basic/conformance.json`, `fixtures/code-graph-provider/basic/provider.sh`, `docs/code-graph-provider-kit.md`, `knowledge/requirements/req-code-graph-provider-kit.md`, `specs/task-code-graph-provider-kit.spec.md`
