...
- `SCHEMA_VERSION` 从 4 增至 5；旧版本沿用 `SchemaMismatch` 响亮拒绝并提示 rebuild。
...
场景: SCIP edge 保留 occurrence site 与 evidence
  测试: test_scip_edges_preserve_occurrence_site_and_evidence
